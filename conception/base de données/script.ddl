...
CREATE TABLE Sujet (id_sujet SERIAL NOT NULL, description varchar(255) NOT NULL, score int4 NOT NULL, "date" date NOT NULL, id_conf int4 NOT NULL, id_user int4 NOT NULL, id_jeux int4, PRIMARY KEY (id_sujet));
